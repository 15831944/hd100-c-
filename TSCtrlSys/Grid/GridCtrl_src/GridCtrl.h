...
public:
	...
	// add by zhang.f 12.17  
//	BOOL IsAuto;
	BOOL m_bLBtnDownEnable;
// Attributes
public:
	...
	CCellID SetSelectCell(CCellID cell);//wsg added 
    CCellID SetSelectCell(int nRow, int nCol);//wsg added
...
public:
    ...
    BOOL   SetGridItemText(int nRow, int nCol, LPCTSTR str);
	...
	int	   GetItemDataInt(int nRow, int nCol) const;
	double GetItemDataDouble(int nRow, int nCol) const;
...
public:
	...
	void ExpandColumnToFit(int Col);
...
public:
	void SetSelectRow(CCellID currentCell, BOOL bForceRedraw=FALSE, BOOL bSelectCells=TRUE);
